...
public function main() {
    io:println(aa(true, 1.375, 0.375));
    io:println(aa(false, 1.375, 0.375));
    io:println(fa(true, 17.75, 2.75));
    io:println(fa(false, 17.75, 2.75));
    io:println(ff(true, 1.5, 0.5));
    io:println(ff(false, 1.5, 0.5));
}
